...
public final long JWT_EXPIRATION = 12 * 60 * 60 * 1000; // 12 hours in milliseconds
    ...
    public String generateToken(User user) {
        ...
        return Jwts.builder()
                ...
                .claim("role", String.valueOf(user.getRole())) // Add role to the token as a String
    ...
    // Get role from the token as a char
    public char getRoleFromToken(String token) {
        ...
        String roleStr = claims.get("role", String.class); // Retrieve role as a String
        return roleStr != null && roleStr.length() > 0 ? roleStr.charAt(0) : '\0'; // Convert to char or return null char if empty
    }
