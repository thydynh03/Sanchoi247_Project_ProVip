...
public String bookSan(@PathVariable("id") int sbid, Model model, HttpSession httpSession, HttpServletRequest httpRequest) throws Exception {
    ...
    String vnpayUrl = VNPayConfig.generateVnpayUrl(String.valueOf(id), String.valueOf((long)(scheduleBooking.getPrice())));
    // Redirect the user to VNPay for payment
    return "redirect:" + vnpayUrl;
}
@GetMapping("/vnpay_return")
public String vnpayReturn(@RequestParam Map<String, String> requestParams, Model model,HttpSession httpSession) throws NumberFormatException, Exception {
